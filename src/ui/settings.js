...
const mainFilterInputElementFileInput = document.getElementById('main-filter-fileInput');
mainFilterInputElement.value = shortenURL(settings.get('user.mainFilter')) || '';
mainFilterInputElementFileInput.oninput = async => {
  const value = mainFilterInputElementFileInput.files[0].path;
